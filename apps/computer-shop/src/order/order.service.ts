...
export class OrderService {
  ...
  public async create(dto: CreateOrderRequestDto) {
    ...
    if (order) {
      ...
      const price = await this.updatePrice(dto.sets, dto.products, discount.amount)
  ...
  public async updatePrice(setId: string[], productIds: string[], discount?: number) {
  ...
  private static calculatePrice(products?: Product[], sets?: Set[], discount?: number) {
